...
public class OrderDao extends AbstractDao<Order> {
    ...
    private static final String FIND_ORDER_BY_USER_ID_SQL = "SELECT o.id, o.time_create, o.cost, os.order_status_name, o.user_id FROM orders AS o JOIN orders_status AS os on o.order_status_id = os.id WHERE o.user_id = ?;";
    ...
    public List<Order> findByUserId(long userId) throws DaoException {
        try (PreparedStatement preparedStatement = connection.prepareStatement(FIND_ORDER_BY_USER_ID_SQL)) {
            preparedStatement.setLong(1, userId);
            ResultSet resultSet = preparedStatement.executeQuery();
            return createListOrderFromResultSet(resultSet);
        } catch (SQLException e) {
